                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-default" href="{{ route('foda-perfiles.edit',$idPerfil->id) }}"><i class="far fa-edit"></i></a>
                                            <a class="btn btn-sm btn-success" href="{{ route('foda-perfiles.show',$idPerfil->id) }}"><i class="fa fa-search" aria-hidden="true"></i>
</a>
